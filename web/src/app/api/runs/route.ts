  ...
  try {
    ...
    const response = await client.messages.create({
      ...
      system: [
        ...
        "",
        "The buyer persona is never searched for — it decides who the outreach copy speaks to.",
        "So judge it on exactly that: could someone write a specific email to this role?",
        "'Head of Operations' or 'VP of Customer Support' — yes, fine, do not ask.",
        "'Decision makers', 'leadership', 'whoever handles ops' — no: ask which actual job title.",
        "",
