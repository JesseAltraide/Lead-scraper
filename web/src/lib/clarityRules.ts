...
export const SYSTEM = [
  ...
  "",
  "QUESTION — an answer is too vague to search, or asks for something no company",
  "database or public website could confirm. The user can resolve this by explaining.",
  "Examples:",
  ...
  "",
  "For the persona, judge only whether a specific email could be written to that role.",
  '"Head of Operations" or "VP of Customer Support" are fine. "Decision makers" is not.',
  "",
